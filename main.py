...
mediapipe_model = load_model('/home/anusree/Videos/sign_language_detection_project/web_app/action.h5')
...
def common_label(lst):
    ...
    #         sentance+=i+','
    #     print(sentance)
    #     # final=bot.prompt(f'construct a short sentance from the words {sentance} keep the words in the same order')
    #     words=[]
    #     # print(final)
    #     time.sleep(1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/anusree/Videos/sign_language_detection_project/web_app/last.pt', help='model.pt path(s)')
